                        ...
                        <a href="{{ route('admin.users.index') }}"
                            ...
                            <svg class="{{ request()->routeIs('admin.users.*') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}"
                                ...
                                <path
                                    ...
                                    fill="" />
                                <path d="M16 13C13.67 13 9 14.17 9 16.5V19H23V16.5C23 14.17 18.33 13 16 13Z"
                                    fill="" />
                                <path
                                    d="M8 11C9.65685 11 11 9.65685 11 8C11 6.34315 9.65685 5 8 5C6.34315 5 5 6.34315 5 8C5 9.65685 6.34315 11 8 11Z"
                                    fill="" />
                                <path
                                    d="M8 13C5.67 13 1 14.17 1 16.5V19H7V16.5C7 16.03 7.09 15.58 7.24 15.16C7.07 15.11 6.89 15.08 6.71 15.08C4.54 15.08 2.68 16.04 2.68 17.32V17.33H7.33C7.62 15.7 8 13 8 13Z"
                                    fill="" />
                            </svg>
                ...
                <ul class="flex flex-col gap-4 mb-6">
                    ...
                    <li>
                        <a href="{{ route('admin.profile.show') }}"
                            class="menu-item group {{ request()->routeIs('admin.profile.show') ? 'menu-item-active' : 'menu-item-inactive' }}">

                            <svg class="{{ request()->routeIs('admin.profile.show') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <li>
                        ...
                        <a href="#"
                            ...
                            class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-gray-200 duration-300 ease-in-out hover:bg-red-600 hover:text-white">

                            <svg class="fill-current w-6 h-6 text-gray-200 group-hover:text-white transition-colors duration-300"
                                viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
